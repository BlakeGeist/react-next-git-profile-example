...
const reducer = (state = exampleInitialState, action) => {
  ...
  switch (action.type) {
    ...
    case actionTypes.ADD_PROFILE:
      {
        const profileDoesNotExist = state.profiles.filter(x => {
...
// CONCATENATED MODULE: ./lib/example.js
...
/* harmony default export */ var example = (App => {
...
/* harmony default export */ var _app = __webpack_exports__["default"] = (example(_app_MyApp));
